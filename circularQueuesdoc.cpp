 ...
 * Project ini merupakan project structur data menggunakan struktur data queues dengan pendekatan circular arrays
 * 
 * @section Operations
 ...
 * @date 2025-06-24
 * 
 * @copyright alvin.wahyu.ft24@mail.umy.ac.id (c) 2025
 * 
 */
...
class Queues{
    ...
    void display(){
        ...
        int REAR_position = REAR;///< variabel rear_position unruk menandakan posisi element terakhir pada variabel rear 
...
int main (){
    Queues q;///< objek untuk menggunakan member yang adad pada clas queues
